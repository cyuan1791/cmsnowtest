...
@CucumberOptions(
        tags = { "@ui-createwebsite-webMasterC", "~@ignore" },
        plugin = { "json:target/CreateWebSiteWebMasterC.json", "html:target/cucumber-report/CreateWebSiteWebMasterC" })
public class CreateWebSiteWebMasterCAT
{
}
